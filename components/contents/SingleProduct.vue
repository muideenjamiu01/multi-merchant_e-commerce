  ...
  <div class="font-light py-8 px-4 text-primary-black">
    <div class="xl:flex xl:space-x-8">
      <div class="flex flex-col space-y-4">
        <div
          v-for="n in 5"
          :key="n"
          class="border-2 border-black h-14 w-14"
        />
      </div>
      <div class="border-2 border-black w-full h-96 max-w-lg" />
      <div>
        <h1 class="text-xl">
          THIS IS WHERE THE NAME OF THE PRODUCT WOULD BE
        </h1>
        ...
        <div class="flex mt-6">
          ...
          <p class="text-primary-gray-light text-sm font-light ml-2.5">
            -23%
          </p>
        </div>
        ...
        <AppButton button-text="Add to cart" color="fillbutton" size="" class="w-full py-2 mt-6" rounded />
        ...
        <div class="mt-5 space-y-5">
          <div class="flex space-x-4">
            ...
            <div class="text-sm space-y-1">
              <h1 class="text-base leading-none">
                Door delivery
              </h1>
    ...
    <div class="mt-24 lg:flex lg:space-x-8">
      ...
      <div class="min-w-88 bg-primary-blue-light py-2.5 pb-10 font-light mt-8">
        <h1 class="font-medium px-6 py-4">
          Seller Information
        </h1>
        <div class="border-t border-gray-200" />
        <div class="px-6 py-4">
          <h1 class="text-primary-blue-dark">
            Mummy's choices store
          </h1>
          ...
          <p class="mt-2 text-sm">
            Order Fulfilment Rate: Excellent
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="mt-8">
      <h1 class="font-bold">
        49 Comments from verified purchase
      </h1>
    ...
    <div>
      <div class="mt-8">
        ...
        <div class="flex gap-x-4 gap-y-6 flex-wrap mt-4">
          <ContentsProductCard v-for="card in 6" :key="card.id" />
        </div>
      </div>
