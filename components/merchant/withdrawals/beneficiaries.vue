    ...
    >
      <thead class="py-3 border-b">
        <tr class="font-medium">
          ...
          <th class="pb-3">Name of Bank</th>
          <th class="pb-3">Date</th>
        </tr>
      </thead>
      <tbody>
        <tr v-for="b in 3" :key="b" class="border-b">
          <td class="w-40 py-3">Marvin Walters</td>
          <td class="w-40 py-3">4839052885</td>
          <td class="w-40 py-3">Wema Bank</td>
...
export default {
  ...
  methods: {
    toggleAddNew() {
      this.newBeneficiaryModal = !this.newBeneficiaryModal;
    },
  },
};
</script>
